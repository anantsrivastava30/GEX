  ...
  direction: {
    ...
    sections: [
      { heading: "States", bullets: [
        ...
        "Not every follow-through works. The durability checklist (gains held, active distribution low, broad participation) is how the page judges whether a bottom is holding.",
      ] },
      { heading: "Entry vs regime", bullets: [
        ...
        "Near EMA appears when an index in an uptrend tests its 20 or 50-day EMA. Confirm that the average is rising and the pullback is orderly before treating it as an entry.",
        "Index exposure is managed by the rally-attempt low and distribution days, not by the 7-8% stock stop; that stop is measured from the stock's actual purchase price.",
      ] },
      { heading: "Scorecard and timing", bullets: [
        ...
        "RSI timing chips are descriptive zones, not buy, wait, or sell instructions.",
  ...
  leaders: {
    ...
    sections: [
      { heading: "Where candidates come from", bullets: [
        "The universe is built from the configured top holdings of every tracked market and sector ETF, plus saved watchlist symbols. It covers market sections but is not an exhaustive all-stock screen.",
      ...
      { heading: "How stocks get flagged", bullets: [
        "Qualified breakout setup means a fresh 52-week-high breakout from a measurable proper base on heavy volume, available C and A fundamentals, top-20% relative strength in the scanned universe, price still in the buy range, and an open market gate. It is a screen result, not a recommendation.",
        "Watch - near 52-week high means the stock is close to its high but has not broken out on volume yet; do not infer that a valid base or pivot exists without reviewing the chart.",
      ...
      { heading: "The letters", bullets: [
        ...
        "I: provider-reported institutional ownership level and its observed direction. The series is typically 13F-lagged; an upward arrow is consistent with increased sponsorship but does not identify current-session fund buying. New symbols show as accruing until enough observations exist.",
      ...
      { heading: "Risk and entry discipline", bullets: [
        "The 7-8% stop is measured from the actual purchase price. Entry vs trigger still matters: a stock more than 5% past its trigger is marked Extended because an ordinary pullback can stop out a chased entry.",
        "Every qualified setup shows the buy limit and an illustrative stop from the current snapshot; replace it with a stop based on the actual fill.",
