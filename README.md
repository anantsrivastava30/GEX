...
- **Stock Leaders** — per-stock CAN SLIM scan across the holdings of every tracked market and sector ETF (quarterly/annual earnings growth, ROE, 52-week-high breakouts on volume, relative strength, institutional sponsorship), gated by the market-direction state and credited to each stock's leading group; fresh breakout buy flags land in the signal feed with O'Neil's pivot-relative entry range and 7-8% stop attached.
